...
export class SettingsPageComponent implements OnInit {
  ...
  getNavItemClass(id: SectionType): string {
    const base = 'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-normal transition-colors cursor-pointer w-full max-md:w-auto max-md:shrink-0 whitespace-nowrap text-left';
