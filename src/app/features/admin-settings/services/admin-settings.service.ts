...
export class AdminSettingsService {
  ...
  getActiveEmployees(): Observable<ApiResponse<{ employees: { id: number; public_id: string; employee_id: string; full_name: string }[] }>> {
    return this.http.get<ApiResponse<{ employees: { id: number; public_id: string; employee_id: string; full_name: string }[] }>>(
